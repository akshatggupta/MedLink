            ...
            <div className="bg-white border-b border-slate-200 pt-24 pb-8 px-4 sm:px-6 lg:px-8">
                <div className="container mx-auto max-w-6xl">
                    <div className="flex justify-between items-end mb-6">
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900 mb-2">Online Pharmacy</h1>
                            <p className="text-slate-500">Genuine medicines delivered to your doorstep.</p>
                        </div>
            ...
            <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8">
                ...
                {filteredMedicines.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-slate-500 text-lg">No medicines found matching your criteria.</p>
                        <Button
                            variant="link"
