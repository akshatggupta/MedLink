          ...
          {navItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                pathname === item.href ? "text-slate-900 font-semibold bg-slate-100" : "text-slate-500"
              )}
            >
              {item.name}
            </Link>
            ...
            <div className="flex flex-col space-y-4">
              {navItems.map((item) => (
                <Link
                  ...
                  className="text-lg font-medium text-slate-600 hover:text-blue-600 p-2"
                >
                  {item.name}
                </Link>
              ))}
              ...
              <Link
                href="/doctors"
                onClick={() => setIsOpen(false)}
                className="text-center text-lg font-medium text-white bg-blue-600 py-3 rounded-xl shadow-lg shadow-blue-200"
              >
                Book Now
              </Link>
            </div>
