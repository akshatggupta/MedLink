    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden bg-slate-50">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                ...
                <div className="absolute top-[10%] right-[-10%] w-[40%] h-[40%] bg-cyan-200/40 rounded-full blur-[120px]" />
                <div className="absolute bottom-[-10%] left-[20%] w-[60%] h-[40%] bg-indigo-200/30 rounded-full blur-[120px]" />
            </div>
            ...
            <div className="relative z-10 container mx-auto px-4 text-center max-w-5xl">
                ...
                >
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-slate-900 mb-8 leading-[1.1] font-serif">
                        Healthcare <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 animate-gradient-x font-sans italic">
                            Reimagined.
                        </span>
                    </h1>

                    <p className="text-xl md:text-2xl text-slate-600 max-w-2xl mx-auto mb-12 leading-relaxed">
                        The #1 AI-powered telemedicine platform. Connect with specialists, manage prescriptions, and track your health—all in one place.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
                        <Link
                            href="/doctors"
                            className="px-8 py-4 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all hover:scale-105 shadow-lg shadow-blue-500/30 flex items-center gap-2"
                        >
                            Get Started
                            ...
                            <div className="absolute top-10 left-10 bg-white p-4 rounded-xl shadow-lg border border-slate-100 animate-float-slow">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-slate-800">Dr. Sarah Johnson</p>
                                    </div>
                                </div>
                            </div>
